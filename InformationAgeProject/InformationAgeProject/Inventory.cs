...
namespace InformationAgeProject
{
	...
	public class Inventory
	{
		...
		public void addTool()
		{
			...
			{
				MessageBox.Show("You cannot acquire anymore tools because all three tools in your inventory are at max level.", "Cannot Acquire More Tools", MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
		}
